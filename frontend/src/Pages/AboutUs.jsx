  ...
  return (
    <div className="bg-bg-darker min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-[1000px] mx-auto py-24 px-8 w-full">
        ...
        <section className="flex flex-col gap-10 relative before:content-[''] before:absolute before:top-8 before:bottom-8 before:left-8 before:w-[2px] before:bg-gradient-to-b before:from-transparent before:via-primary/30 before:to-transparent before:z-0 md:before:hidden">
          <div className="glass-card p-14 pl-20 relative overflow-hidden md:p-10 md:pl-8 after:content-[''] after:absolute after:top-1/2 after:left-[26px] after:-translate-y-1/2 after:w-3.5 after:h-3.5 after:bg-bg after:border-2 after:border-primary-light after:rounded-full after:shadow-[0_0_10px_var(--color-primary-light)] after:z-10 md:after:hidden" data-aos="fade-right" data-aos-delay="100">
            <h3 className="text-[1.75rem] mb-5 text-primary-light flex items-center gap-3">
              <FontAwesomeIcon icon={faBullseye} /> Our Mission
            </h3>
            <p className="text-[1.05rem] leading-[1.8] text-text-muted m-0">
          ...
          <div className="glass-card p-14 pl-20 relative overflow-hidden md:p-10 md:pl-8 after:content-[''] after:absolute after:top-1/2 after:left-[26px] after:-translate-y-1/2 after:w-3.5 after:h-3.5 after:bg-bg after:border-2 after:border-secondary-light after:rounded-full after:shadow-[0_0_10px_var(--color-secondary-light)] after:z-10 md:after:hidden" data-aos="fade-left" data-aos-delay="200">
            <h3 className="text-[1.75rem] mb-5 text-secondary-light flex items-center gap-3">
