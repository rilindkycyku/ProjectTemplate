...
const Footer = () => {
    ...
    return (
        <footer className="bg-bg-darker border-t border-white/5 pt-16 pb-8 relative z-10 before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-px before:bg-gradient-to-r before:from-transparent before:via-primary-light/30 before:to-transparent">
            <div className="max-w-[1200px] mx-auto px-8 grid grid-cols-[1.5fr_1fr_1.5fr] gap-12 pb-12 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1.5fr]">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <p className="text-text-muted text-[0.95rem] leading-[1.7] m-0 max-w-[320px]">
                        {settings?.pershkrimi}
                    </p>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {settings?.email && (
                        <a href={`mailto:${settings.email}`} className="text-text-muted text-[0.95rem] transition-colors hover:text-primary-light">
                            {settings.email}
                        </a>
                    )}
                    {settings?.telefoni && (
            ...
            <div className="max-w-[1200px] mx-auto px-8 pt-8 border-t border-white/5 flex justify-between items-center flex-wrap gap-4 sm:flex-col sm:text-center">
                ...
                <div className="inline-flex items-center gap-2 bg-white/5 border border-white/5 rounded-full px-3 py-1.5 text-[0.8rem] text-text-muted font-medium">
